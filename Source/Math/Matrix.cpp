...
template <class ElemType>
void Matrix<ElemType>::ROIPoolingForward(const size_t numRois, const size_t numImg, const size_t channels, const size_t height, const size_t width,
                                         const size_t pooledHeight, const size_t pooledWidth, const Matrix<ElemType>& roiData, Matrix<ElemType>& output, 
                                         Matrix<ElemType>& argmax) const
{
    ...
    DISPATCH_MATRIX_ON_FLAG(this,
                            this,
                            m_CPUMatrix->ROIPoolingForward(numRois, numImg, channels, height, width, pooledHeight, pooledWidth, *(roiData.m_CPUMatrix), *(output.m_CPUMatrix), *(argmax.m_CPUMatrix)),
                            m_GPUMatrix->ROIPoolingForward(numRois, numImg, channels, height, width, pooledHeight, pooledWidth, *(roiData.m_GPUMatrix), *(output.m_GPUMatrix), *(argmax.m_GPUMatrix)),
                            NOT_IMPLEMENTED,
                            NOT_IMPLEMENTED);
}

template <class ElemType>
void Matrix<ElemType>::ROIPoolingBackward(const size_t numRois, const size_t numImg, const size_t channels, const size_t height, const size_t width,
                                          const size_t pooledHeight, const size_t pooledWidth, const Matrix<ElemType>& roiData, Matrix<ElemType>& grad, 
                                          Matrix<ElemType>& argmax) const
{
    DecideAndMoveToRightDevice(*this, grad);
    ...
    DISPATCH_MATRIX_ON_FLAG(this,
                            this,
                            m_CPUMatrix->ROIPoolingBackward(numRois, numImg, channels, height, width, pooledHeight, pooledWidth, *(roiData.m_CPUMatrix), *(grad.m_CPUMatrix), *(argmax.m_CPUMatrix)),
                            m_GPUMatrix->ROIPoolingBackward(numRois, numImg, channels, height, width, pooledHeight, pooledWidth, *(roiData.m_GPUMatrix), *(grad.m_GPUMatrix), *(argmax.m_GPUMatrix)),
                            NOT_IMPLEMENTED,
                            NOT_IMPLEMENTED);
}
