...
void GPUMatrix<ElemType>::ROIPoolingForward(const size_t numRois, const size_t numImg, const size_t channels, const size_t height, const size_t width,
                                            const size_t pooledHeight, const size_t pooledWidth, const GPUMatrix<ElemType>& roiData, GPUMatrix<ElemType>& output, 
...
void GPUMatrix<ElemType>::ROIPoolingBackward(const size_t numRois, const size_t numImg, const size_t channels, const size_t height, const size_t width,
                                             const size_t pooledHeight, const size_t pooledWidth, const GPUMatrix<ElemType>& roiData, GPUMatrix<ElemType>& grad, 
                                             GPUMatrix<ElemType>& argmax) const
{
    PrepareDevice();
    SyncGuard syncGuard;
