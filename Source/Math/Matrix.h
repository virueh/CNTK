...
public:
	...
	void ROIPoolingForward(const size_t numRois, const size_t numImg, const size_t channels, const size_t height, const size_t width,
                           const size_t pooledHeight, const size_t pooledWidth, const Matrix<ElemType>& roiData, Matrix<ElemType>& output, Matrix<ElemType>& argmax) const;
    ...
    void ROIPoolingBackward(const size_t numRois, const size_t numImg, const size_t channels, const size_t height, const size_t width,
                            const size_t pooledHeight, const size_t pooledWidth, const Matrix<ElemType>& roiData, Matrix<ElemType>& grad, Matrix<ElemType>& argmax) const;
