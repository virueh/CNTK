...
public:
	...
	void ROIPoolingForward(const size_t numRois, const size_t numImg, const size_t channels, const size_t height, const size_t width,
                           const size_t pooledHeight, const size_t pooledWidth, const CPUMatrix<ElemType>& roiData, CPUMatrix<ElemType>& output, CPUMatrix<ElemType>& argmax) const;

    void ROIPoolingBackward(const size_t numRois, const size_t numImg, const size_t channels, const size_t height, const size_t width,
                            const size_t pooledHeight, const size_t pooledWidth, const CPUMatrix<ElemType>& roiData, CPUMatrix<ElemType>& grad, CPUMatrix<ElemType>& argmax) const;
